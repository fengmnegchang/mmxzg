 ...
 * @createTime:2017-8-17上午11:04:59
 * @version:4.2.4
 * @modifyTime:
 * @modifyAuthor:
 * @description:
 ...
 *****************************************************************************************************************************************************************************
 */
public class MWapMainSlideMenuActivity extends SlidingFragmentActivity {
	private String url = UrlUtils.MMXZG_E_WAP;
...
//		getSupportFragmentManager().beginTransaction().replace(R.id.id_left_menu_frame,new MenuLeftFragment()).commit();
		MWapLeftMenuPullListMVPFragmnet frament = MWapLeftMenuPullListMVPFragmnet.newInstance(true);
		getSupportFragmentManager().beginTransaction().replace(R.id.id_left_menu_frame,frament).commit();
		new MWapLeftMenuPullListPresenterImpl(this, frament, url);
