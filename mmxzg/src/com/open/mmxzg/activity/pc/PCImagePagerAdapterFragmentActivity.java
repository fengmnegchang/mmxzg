...
import com.open.mmxzg.fragment.pc.PCImagePagerAdapterFragment;
 ...
 *****************************************************************************************************************************************************************************
 */
public class PCImagePagerAdapterFragmentActivity extends CommonFragmentActivity<MArticleJson> {
	private String url = UrlUtils.MM_PC_IMAGE;
	@Override
	...
	protected void initValue() {
		...
		if(mShowJson!=null && mShowJson.getList()!=null&& mShowJson.getList().size()>0){
			fragment = PCImagePagerAdapterFragment.newInstance(url, true,weakReferenceHandler,mShowJson.getList(),mShowJson.getCurrentPosition());
		}else{
			fragment = PCImagePagerAdapterFragment.newInstance(url, true,weakReferenceHandler);
		}
	...
	public static void startPCImagePagerAdapterFragmentActivity(Context context, String url,MArticleJson mMArticleJson) {
		Intent intent = new Intent();
		intent.putExtra("SHOW_JSON", mMArticleJson);
		intent.putExtra("URL", url);
		intent.setClass(context, PCImagePagerAdapterFragmentActivity.class);
