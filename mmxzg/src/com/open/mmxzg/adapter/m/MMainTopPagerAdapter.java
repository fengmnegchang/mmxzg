 ...
 *****************************************************************************************************************************************************************************
 */
public class MMainTopPagerAdapter extends CommonPagerAdapter<MArticleBean>{
	public AbstractAnimatedDrawable animatable;
	public MMainTopPagerAdapter(Context mContext, List<MArticleBean> list) {
		super(mContext, list);
	}
	...
	public Object instantiateItem(ViewGroup container, int position) {
		...
		View convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_m_main_top_viewpager, null);
