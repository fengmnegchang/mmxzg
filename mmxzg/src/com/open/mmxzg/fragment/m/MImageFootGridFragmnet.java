 ...
 *****************************************************************************************************************************************************************************
 */
public class MImageFootGridFragmnet extends CommonPullToRefreshGridFragment<MArticleBean, MArticleJson> {
	private MArticleGridAdapter mMArticleGridAdapter;
	
	public static MImageFootGridFragmnet newInstance(String url, boolean isVisibleToUser) {
		MImageFootGridFragmnet fragment = new MImageFootGridFragmnet();
