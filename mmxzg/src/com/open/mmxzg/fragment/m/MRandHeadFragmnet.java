 ...
 *****************************************************************************************************************************************************************************
 */
public class MRandHeadFragmnet extends BaseV4Fragment<MArticleJson, MRandHeadFragmnet> {
	public TextView text_camLiDes;
	public SimpleDraweeView mSimpleDraweeView;
	public AbstractAnimatedDrawable animatable;
	
	public static MRandHeadFragmnet newInstance(String url, boolean isVisibleToUser) {
		MRandHeadFragmnet fragment = new MRandHeadFragmnet();
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		View view = inflater.inflate(R.layout.fragment_m_rand, container, false);
