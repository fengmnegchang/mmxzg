...
import com.open.mmxzg.adapter.m.MSexNovelListAdapter;
 ...
 *****************************************************************************************************************************************************************************
 */
public class MSexNovelPullListFragmnet extends CommonPullToRefreshListFragment<MArticleBean, MArticleJson> {
	public MSexNovelListAdapter mMSexNovelListAdapter;

	public static MSexNovelPullListFragmnet newInstance(String url, boolean isVisibleToUser) {
		MSexNovelPullListFragmnet fragment = new MSexNovelPullListFragmnet();
	...
	public void initValues() {
		...
		mMSexNovelListAdapter = new MSexNovelListAdapter(getActivity(), list);
		mPullToRefreshListView.setAdapter(mMSexNovelListAdapter);
	...
	public MArticleJson call() throws Exception {
		...
		String typename = "MArticleJsoupService-parseSexNovelList-"+pageNo;
		if(NetWorkUtils.isNetworkAvailable(getActivity())){
			mMArticleJson.setList(MArticleJsoupService.parseSexNovelList(href, pageNo));
			try {
				//数据存储
				Gson gson = new Gson();
	...
	public void onCallback(MArticleJson result) {
		...
		mMSexNovelListAdapter.notifyDataSetChanged();
