...
import com.open.mmxzg.adapter.app.MListHorizontalAdapter;
import com.open.mmxzg.bean.app.OpenDBListBean;
 ...
 *****************************************************************************************************************************************************************************
 */
public class MHistoryListHorizontalListMVPFragment extends MHistoryListGridMVPFragment {
	public MListHorizontalAdapter mMListHorizontalAdapter;
	public static MHistoryListHorizontalListMVPFragment newInstance(String url, boolean isVisibleToUser) {
		MHistoryListHorizontalListMVPFragment fragment = new MHistoryListHorizontalListMVPFragment();
