 ...
 *****************************************************************************************************************************************************************************
 */
public class MLeftMenuPullListMVPFragment extends CommonPullToRefreashListMVPFragment<MSlideMenuBean, MSlideMenuJson,MLeftMenuPullListPresenter>
implements MLeftMenuPullListView<MSlideMenuJson,MLeftMenuPullListPresenter>{
	public MSlideMenuAdapter mMSlideMenuAdapter;
	
	public static MLeftMenuPullListMVPFragment newInstance(boolean isVisibleToUser) {
		MLeftMenuPullListMVPFragment fragment = new MLeftMenuPullListMVPFragment();
